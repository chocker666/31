...
{
static const size_t packet_size = sizeof(rslidar_msgs::rslidarPacket_bp().data);
...
int InputSocket::getPacket(rslidar_msgs::rslidarPacket_bp* pkt, const double time_offset)
{
...
/** @brief Get one rslidar packet. */
int InputPCAP::getPacket(rslidar_msgs::rslidarPacket_bp* pkt, const double time_offset)
{
