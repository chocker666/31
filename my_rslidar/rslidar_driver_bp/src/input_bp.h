...
public:
  ...
  virtual int getPacket(rslidar_msgs::rslidarPacket_bp* pkt, const double time_offset) = 0;
...
public:
  ...
  virtual int getPacket(rslidar_msgs::rslidarPacket_bp* pkt, const double time_offset);
