...
#include <rslidar_msgs/rslidarPacket_bp.h>
#include <rslidar_msgs/rslidarScan_bp.h>
...
public:
  ...
  void unpack(const rslidar_msgs::rslidarPacket_bp& pkt, pcl::PointCloud<pcl::PointXYZI>::Ptr pointcloud);

  /*unpack the RS32 UDP packet and opuput PCL PointXYZI type*/
  void unpack_RS32(const rslidar_msgs::rslidarPacket_bp& pkt, pcl::PointCloud<pcl::PointXYZI>::Ptr pointcloud);
  ...
  void processDifop(const rslidar_msgs::rslidarPacket_bp::ConstPtr& difop_msg);
